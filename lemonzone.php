  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
			<button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> Os Meus Grupos</button>
			<div id="Demo1" class="w3-hide w3-container">
				<p>Some text..</p>
			</div>
			<button onclick="myFunction('Demo2')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> Os Meus Eventos</button>
				...
				<div class="w3-card w3-round w3-white">
					<div class="w3-container w3-padding">
						...
						<form name="f1" method="POST" action="lemonstatus.php">
							...
							<button type="submit" onclick="secStatus()" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Post</button> 
    ...
    <div class="w3-card w3-round w3-white w3-center">
		<div class="w3-container">
			...
			<form method='POST' name='f2' action='search_friends.php'>
			
				<i class="fa fa-search"></i>
				<input type='text' name='search' maxlength='20' class="w3-input">
				
				
				<!---
				<span id='s1'> </span> </td> <td> <span id='s2'>
				<input type='button' value='Search' onclick='secFriends()'>
			--->
			</form>
